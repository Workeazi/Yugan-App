          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'These Terms & Conditions ("Terms") govern your access to and use of the YUGAN mobile application and any related services (collectively, the "Service"). By downloading, accessing or using the Service, you agree to be bound by these Terms. If you do not agree to these Terms, you must not use the Service.',
