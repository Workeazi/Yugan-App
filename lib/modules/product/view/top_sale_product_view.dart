...
import '../controller/top_sale_product_controller.dart';

class TopSaleProductView extends StatefulWidget {
  const TopSaleProductView({super.key});

  @override
  State<TopSaleProductView> createState() => _TopSaleProductViewState();
}

class _TopSaleProductViewState extends State<TopSaleProductView> {
  final _scrollCtrl = ScrollController();
  late final TopSaleProductController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.put(TopSaleProductController(), permanent: false);
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      controller.open(categoryId: catId, titleOverride: titleOverride);
    });
  }
  ...
  Future<void> _openFilter() async {
    final res = await Get.toNamed(
      ...
      arguments: {
        ...
        'currentBrandId': controller.currentBrandId.isEmpty
            ? null
            : int.tryParse(controller.currentBrandId),
...
class _ListCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final controller = Get.find<TopSaleProductController>();
