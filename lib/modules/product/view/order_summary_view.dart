...
import '../../account/controller/my_order_details_controller.dart';
import '../../account/model/my_order_details_model.dart';

class OrderSummaryView extends StatefulWidget {
  final int orderId;

  const OrderSummaryView({super.key, required this.orderId});
...
class _OrderSummaryViewState extends State<OrderSummaryView> {
  ...
  void initState() {
    super.initState();
    _controller = Get.put(OrderDetailsController());
          ...
          child: OutlinedButton(
            onPressed: () {
              Get.toNamed(
                ...
                arguments: {'order_id': d.id, 'from_summary': true},
              );
            },
